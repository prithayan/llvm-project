...
source_filename = "DRACC_OMP_023_MxV_Partially_Missing_Data_yes.c"
...
@1 = private unnamed_addr constant [61 x i8] c";DRACC_OMP_023_MxV_Partially_Missing_Data_yes.c;Mult;32;17;;\00", align 1
...
@3 = private unnamed_addr constant [61 x i8] c";DRACC_OMP_023_MxV_Partially_Missing_Data_yes.c;Mult;32;50;;\00", align 1
...
@.__omp_offloading_801_15a4795_Mult_l30.region_id = weak constant i8 0
@.offload_sizes = private unnamed_addr constant [3 x i64] [i64 2048, i64 2048, i64 2048]
@.offload_maptypes = private unnamed_addr constant [3 x i64] [i64 35, i64 33, i64 33]
@.str.3 = private unnamed_addr constant [23 x i8] c"Data Race occured: %s\0A\00", align 1
@.str.4 = private unnamed_addr constant [5 x i8] c"true\00", align 1
@.str.5 = private unnamed_addr constant [6 x i8] c"false\00", align 1
@.omp_offloading.entry_name = internal unnamed_addr constant [38 x i8] c"__omp_offloading_801_15a4795_Mult_l30\00"
@.omp_offloading.entry.__omp_offloading_801_15a4795_Mult_l30 = weak constant %struct.__tgt_offload_entry { i8* @.__omp_offloading_801_15a4795_Mult_l30.region_id, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.omp_offloading.entry_name, i32 0, i32 0), i64 0, i32 0, i32 0 }, section ".omp_offloading.entries", align 1
...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  %cmp2 = icmp slt i32 %4, 512, !dbg !41
...
entry:
  ...
  call void @__kmpc_push_target_tripcount(i64 0, i64 512), !dbg !69
  ...
  %23 = call i32 @__tgt_target_teams(i64 0, i8* @.__omp_offloading_801_15a4795_Mult_l30.region_id, i32 3, i8** %21, i8** %22, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @.offload_sizes, i32 0, i32 0), i64* getelementptr inbounds ([3 x i64], [3 x i64]* @.offload_maptypes, i32 0, i32 0), i32 0, i32 0), !dbg !69
  %24 = icmp ne i32 %23, 0, !dbg !69
  br i1 %24, label %omp_offload.failed, label %omp_offload.cont, !dbg !69

omp_offload.failed:                               ; preds = %entry
  call void @__omp_offloading_801_15a4795_Mult_l30(i32* %0, i32* %1, i32* %2) #6, !dbg !74
...
define internal void @__omp_offloading_801_15a4795_Mult_l30_debug__(i32* %c, i32* %b, i32* %a) #3 !dbg !76 {
entry:
  ...
  store i8* getelementptr inbounds ([61 x i8], [61 x i8]* @1, i32 0, i32 0), i8** %2, align 8, !dbg !86, !tbaa !88
...
entry:
  ...
  store i32 511, i32* %.omp.comb.ub, align 4, !dbg !116, !tbaa !29
  ...
  store i8* getelementptr inbounds ([61 x i8], [61 x i8]* @1, i32 0, i32 0), i8** %11, align 8, !dbg !115, !tbaa !88
  ...
  %cmp = icmp sgt i32 %14, 511, !dbg !116
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ 511, %cond.true ], [ %15, %cond.false ], !dbg !116
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  store i8* getelementptr inbounds ([61 x i8], [61 x i8]* @1, i32 0, i32 0), i8** %23, align 8, !dbg !117, !tbaa !88
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  store i8* getelementptr inbounds ([61 x i8], [61 x i8]* @1, i32 0, i32 0), i8** %26, align 8, !dbg !118, !tbaa !88
...
entry:
  ...
  store i32 511, i32* %.omp.ub, align 4, !dbg !152, !tbaa !29
  ...
  store i8* getelementptr inbounds ([61 x i8], [61 x i8]* @1, i32 0, i32 0), i8** %13, align 8, !dbg !151, !tbaa !88
  ...
  %cmp = icmp sgt i32 %16, 511, !dbg !152
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ 511, %cond.true ], [ %17, %cond.false ], !dbg !152
...
for.cond:                                         ; preds = %for.inc, %omp.inner.for.body
  ...
  %cmp5 = icmp slt i32 %23, 512, !dbg !158
...
for.body:                                         ; preds = %for.cond
  ...
  %mul7 = mul nsw i32 %27, 512, !dbg !165
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  store i8* getelementptr inbounds ([61 x i8], [61 x i8]* @3, i32 0, i32 0), i8** %37, align 8, !dbg !178, !tbaa !88
...
; Function Attrs: norecurse nounwind uwtable
define internal void @__omp_offloading_801_15a4795_Mult_l30(i32* %c, i32* %b, i32* %a) #3 !dbg !204 {
entry:
  %c.addr = alloca i32*, align 8
  %b.addr = alloca i32*, align 8
  %a.addr = alloca i32*, align 8
  ...
  call void @__omp_offloading_801_15a4795_Mult_l30_debug__(i32* %0, i32* %1, i32* %2) #6, !dbg !210
  ret void, !dbg !210
}
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %cmp = icmp slt i32 %1, 512, !dbg !225
...
for.body:                                         ; preds = %for.cond
  ...
  %cmp1 = icmp ne i32 %5, 512, !dbg !232
...
!1 = distinct !DIGlobalVariable(name: "b", scope: !2, file: !3, line: 12, type: !8, isLocal: false, isDefinition: true)
!2 = distinct !DICompileUnit(language: DW_LANG_C99, file: !3, producer: "clang version 9.0.0 (git@github.com:prithayan/llvm-project.git 11be78bc7abf469c2db2d631f11b02ec8cb9f3c5)", isOptimized: true, runtimeVersion: 0, emissionKind: FullDebug, enums: !4, globals: !5, nameTableKind: None)
!3 = !DIFile(filename: "DRACC_OMP_023_MxV_Partially_Missing_Data_yes.c", directory: "/home/prithayan/project/openmp_benchmark/testsuite/DRACC/OpenMP")
!4 = !{}
!5 = !{!6, !0, !10}
!6 = !DIGlobalVariableExpression(var: !7, expr: !DIExpression())
!7 = distinct !DIGlobalVariable(name: "a", scope: !2, file: !3, line: 11, type: !8, isLocal: false, isDefinition: true)
!8 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !9, size: 64)
!9 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!10 = !DIGlobalVariableExpression(var: !11, expr: !DIExpression())
!11 = distinct !DIGlobalVariable(name: "c", scope: !2, file: !3, line: 13, type: !8, isLocal: false, isDefinition: true)
!12 = !{i32 0, i32 2049, i32 22693781, !"Mult", i32 30, i32 0}
!13 = !{i32 2, !"Dwarf Version", i32 4}
!14 = !{i32 2, !"Debug Info Version", i32 3}
!15 = !{i32 1, !"wchar_size", i32 4}
!16 = !{!"clang version 9.0.0 (git@github.com:prithayan/llvm-project.git 11be78bc7abf469c2db2d631f11b02ec8cb9f3c5)"}
!17 = distinct !DISubprogram(name: "init", scope: !3, file: !3, line: 16, type: !18, scopeLine: 16, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !20)
!18 = !DISubroutineType(types: !19)
!19 = !{!9}
!20 = !{!21, !23}
!21 = !DILocalVariable(name: "i", scope: !22, file: !3, line: 17, type: !9)
!22 = distinct !DILexicalBlock(scope: !17, file: !3, line: 17, column: 5)
!23 = !DILocalVariable(name: "j", scope: !24, file: !3, line: 18, type: !9)
!24 = distinct !DILexicalBlock(scope: !25, file: !3, line: 18, column: 9)
!25 = distinct !DILexicalBlock(scope: !26, file: !3, line: 17, column: 27)
...
!32 = !{!"Simple C/C++ TBAA"}
!33 = !DILocation(line: 17, column: 18, scope: !26)
!34 = !DILocation(line: 17, column: 19, scope: !26)
!35 = !DILocation(line: 17, column: 5, scope: !22)
!36 = !DILocation(line: 17, column: 5, scope: !26)
!37 = !DILocation(line: 18, column: 13, scope: !24)
!38 = !DILocation(line: 18, column: 17, scope: !24)
!39 = !DILocation(line: 18, column: 22, scope: !40)
!40 = distinct !DILexicalBlock(scope: !24, file: !3, line: 18, column: 9)
!41 = !DILocation(line: 18, column: 23, scope: !40)
!42 = !DILocation(line: 18, column: 9, scope: !24)
!43 = !DILocation(line: 18, column: 9, scope: !40)
!44 = !DILocation(line: 19, column: 13, scope: !45)
!45 = distinct !DILexicalBlock(scope: !40, file: !3, line: 18, column: 31)
!46 = !{!47, !47, i64 0}
!47 = !{!"any pointer", !31, i64 0}
!48 = !DILocation(line: 19, column: 15, scope: !45)
!49 = !DILocation(line: 19, column: 17, scope: !45)
!50 = !DILocation(line: 19, column: 18, scope: !45)
!51 = !DILocation(line: 19, column: 16, scope: !45)
!52 = !DILocation(line: 19, column: 21, scope: !45)
!53 = !DILocation(line: 20, column: 9, scope: !45)
!54 = !DILocation(line: 18, column: 28, scope: !40)
!55 = distinct !{!55, !42, !56}
!56 = !DILocation(line: 20, column: 9, scope: !24)
!57 = !DILocation(line: 21, column: 9, scope: !25)
!58 = !DILocation(line: 21, column: 11, scope: !25)
!59 = !DILocation(line: 21, column: 13, scope: !25)
!60 = !DILocation(line: 22, column: 9, scope: !25)
!61 = !DILocation(line: 22, column: 11, scope: !25)
!62 = !DILocation(line: 22, column: 13, scope: !25)
!63 = !DILocation(line: 23, column: 5, scope: !25)
!64 = !DILocation(line: 17, column: 24, scope: !26)
!65 = distinct !{!65, !35, !66}
!66 = !DILocation(line: 23, column: 5, scope: !22)
!67 = !DILocation(line: 24, column: 9, scope: !17)
!68 = distinct !DISubprogram(name: "Mult", scope: !3, file: !3, line: 28, type: !18, scopeLine: 28, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !4)
!69 = !DILocation(line: 30, column: 13, scope: !68)
!70 = !DILocation(line: 30, column: 57, scope: !71)
!71 = distinct !DILexicalBlock(scope: !68, file: !3, line: 30, column: 13)
!72 = !DILocation(line: 30, column: 38, scope: !71)
!73 = !DILocation(line: 30, column: 31, scope: !71)
!74 = !DILocation(line: 30, column: 13, scope: !71)
!75 = !DILocation(line: 40, column: 5, scope: !68)
!76 = distinct !DISubprogram(name: "__omp_offloading_801_15a4795_Mult_l30_debug__", scope: !3, file: !3, line: 31, type: !77, scopeLine: 31, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !79)
!77 = !DISubroutineType(types: !78)
!78 = !{null, !8, !8, !8}
!79 = !{!80, !81, !82}
!80 = !DILocalVariable(name: "c", arg: 1, scope: !76, file: !3, line: 13, type: !8)
!81 = !DILocalVariable(name: "b", arg: 2, scope: !76, file: !3, line: 12, type: !8)
!82 = !DILocalVariable(name: "a", arg: 3, scope: !76, file: !3, line: 11, type: !8)
!83 = !DILocation(line: 13, column: 6, scope: !76)
!84 = !DILocation(line: 12, column: 6, scope: !76)
!85 = !DILocation(line: 11, column: 6, scope: !76)
!86 = !DILocation(line: 32, column: 17, scope: !87)
!87 = distinct !DILexicalBlock(scope: !76, file: !3, line: 31, column: 5)
!88 = !{!89, !47, i64 16}
!89 = !{!"ident_t", !30, i64 0, !30, i64 4, !30, i64 8, !30, i64 12, !47, i64 16}
!90 = !DILocation(line: 38, column: 5, scope: !76)
!91 = distinct !DISubprogram(name: ".omp_outlined._debug__", scope: !3, file: !3, line: 33, type: !92, scopeLine: 33, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !99)
...
!102 = !DILocalVariable(name: "c", arg: 3, scope: !91, file: !3, line: 13, type: !98)
!103 = !DILocalVariable(name: "b", arg: 4, scope: !91, file: !3, line: 12, type: !98)
!104 = !DILocalVariable(name: "a", arg: 5, scope: !91, file: !3, line: 11, type: !98)
...
!112 = !DILocation(line: 13, column: 6, scope: !91)
!113 = !DILocation(line: 12, column: 6, scope: !91)
!114 = !DILocation(line: 11, column: 6, scope: !91)
!115 = !DILocation(line: 33, column: 9, scope: !91)
!116 = !DILocation(line: 33, column: 13, scope: !91)
!117 = !DILocation(line: 32, column: 17, scope: !91)
!118 = !DILocation(line: 32, column: 50, scope: !119)
!119 = distinct !DILexicalBlock(scope: !91, file: !3, line: 32, column: 17)
!120 = distinct !{!120, !117, !121}
!121 = !DILocation(line: 32, column: 50, scope: !91)
!122 = !DILocation(line: 37, column: 9, scope: !91)
!123 = distinct !DISubprogram(name: ".omp_outlined._debug__.1", scope: !3, file: !3, line: 33, type: !124, scopeLine: 33, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !128)
...
!133 = !DILocalVariable(name: "c", arg: 5, scope: !123, file: !3, line: 13, type: !98)
!134 = !DILocalVariable(name: "b", arg: 6, scope: !123, file: !3, line: 12, type: !98)
!135 = !DILocalVariable(name: "a", arg: 7, scope: !123, file: !3, line: 11, type: !98)
...
!142 = !DILocalVariable(name: "j", scope: !143, file: !3, line: 34, type: !9)
!143 = distinct !DILexicalBlock(scope: !144, file: !3, line: 34, column: 13)
!144 = distinct !DILexicalBlock(scope: !123, file: !3, line: 33, column: 31)
!145 = !DILocation(line: 0, scope: !123)
!146 = !{!147, !147, i64 0}
!147 = !{!"long", !31, i64 0}
!148 = !DILocation(line: 13, column: 6, scope: !123)
!149 = !DILocation(line: 12, column: 6, scope: !123)
!150 = !DILocation(line: 11, column: 6, scope: !123)
!151 = !DILocation(line: 33, column: 9, scope: !123)
!152 = !DILocation(line: 33, column: 13, scope: !123)
!153 = !DILocation(line: 33, column: 27, scope: !123)
!154 = !DILocation(line: 34, column: 17, scope: !143)
!155 = !DILocation(line: 34, column: 21, scope: !143)
!156 = !DILocation(line: 34, column: 26, scope: !157)
!157 = distinct !DILexicalBlock(scope: !143, file: !3, line: 34, column: 13)
!158 = !DILocation(line: 34, column: 27, scope: !157)
!159 = !DILocation(line: 34, column: 13, scope: !143)
!160 = !DILocation(line: 34, column: 13, scope: !157)
!161 = !DILocation(line: 35, column: 23, scope: !162)
!162 = distinct !DILexicalBlock(scope: !157, file: !3, line: 34, column: 35)
!163 = !DILocation(line: 35, column: 25, scope: !162)
!164 = !DILocation(line: 35, column: 27, scope: !162)
!165 = !DILocation(line: 35, column: 28, scope: !162)
!166 = !DILocation(line: 35, column: 26, scope: !162)
!167 = !DILocation(line: 35, column: 32, scope: !162)
!168 = !DILocation(line: 35, column: 34, scope: !162)
!169 = !DILocation(line: 35, column: 31, scope: !162)
!170 = !DILocation(line: 35, column: 17, scope: !162)
!171 = !DILocation(line: 35, column: 19, scope: !162)
!172 = !DILocation(line: 35, column: 21, scope: !162)
!173 = !DILocation(line: 36, column: 13, scope: !162)
!174 = !DILocation(line: 34, column: 32, scope: !157)
!175 = distinct !{!175, !159, !176}
!176 = !DILocation(line: 36, column: 13, scope: !143)
!177 = !DILocation(line: 37, column: 9, scope: !144)
!178 = !DILocation(line: 32, column: 17, scope: !123)
!179 = distinct !{!179, !178, !180}
!180 = !DILocation(line: 32, column: 50, scope: !123)
!181 = !DILocation(line: 37, column: 9, scope: !123)
!182 = distinct !DISubprogram(name: ".omp_outlined.", scope: !3, file: !3, line: 33, type: !124, scopeLine: 33, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !183)
...
!192 = !DILocation(line: 33, column: 9, scope: !182)
!193 = !{!194}
!194 = !{i64 2, i64 -1, i64 -1, i1 true}
!195 = distinct !DISubprogram(name: ".omp_outlined..2", scope: !3, file: !3, line: 33, type: !92, scopeLine: 33, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !196)
...
!203 = !DILocation(line: 33, column: 9, scope: !195)
!204 = distinct !DISubprogram(name: "__omp_offloading_801_15a4795_Mult_l30", scope: !3, file: !3, line: 31, type: !77, scopeLine: 31, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !205)
!205 = !{!206, !207, !208}
...
!210 = !DILocation(line: 31, column: 5, scope: !204)
!211 = distinct !DISubprogram(name: "check", scope: !3, file: !3, line: 43, type: !18, scopeLine: 43, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !212)
!212 = !{!213, !215}
!213 = !DILocalVariable(name: "test", scope: !211, file: !3, line: 44, type: !214)
!214 = !DIBasicType(name: "_Bool", size: 8, encoding: DW_ATE_boolean)
!215 = !DILocalVariable(name: "i", scope: !216, file: !3, line: 45, type: !9)
!216 = distinct !DILexicalBlock(scope: !211, file: !3, line: 45, column: 5)
!217 = !DILocation(line: 44, column: 5, scope: !211)
!218 = !DILocation(line: 44, column: 10, scope: !211)
!219 = !{!220, !220, i64 0}
!220 = !{!"_Bool", !31, i64 0}
!221 = !DILocation(line: 45, column: 9, scope: !216)
!222 = !DILocation(line: 45, column: 13, scope: !216)
!223 = !DILocation(line: 45, column: 18, scope: !224)
!224 = distinct !DILexicalBlock(scope: !216, file: !3, line: 45, column: 5)
!225 = !DILocation(line: 45, column: 19, scope: !224)
!226 = !DILocation(line: 45, column: 5, scope: !216)
!227 = !DILocation(line: 45, column: 5, scope: !224)
!228 = !DILocation(line: 46, column: 12, scope: !229)
!229 = distinct !DILexicalBlock(scope: !230, file: !3, line: 46, column: 12)
!230 = distinct !DILexicalBlock(scope: !224, file: !3, line: 45, column: 27)
!231 = !DILocation(line: 46, column: 14, scope: !229)
!232 = !DILocation(line: 46, column: 16, scope: !229)
!233 = !DILocation(line: 46, column: 12, scope: !230)
!234 = !DILocation(line: 47, column: 18, scope: !235)
!235 = distinct !DILexicalBlock(scope: !229, file: !3, line: 46, column: 20)
!236 = !DILocation(line: 48, column: 9, scope: !235)
!237 = !DILocation(line: 49, column: 5, scope: !230)
!238 = !DILocation(line: 45, column: 24, scope: !224)
!239 = distinct !{!239, !226, !240}
!240 = !DILocation(line: 49, column: 5, scope: !216)
!241 = !DILocation(line: 50, column: 38, scope: !211)
!242 = !{i8 0, i8 2}
!243 = !DILocation(line: 50, column: 5, scope: !211)
!244 = !DILocation(line: 52, column: 1, scope: !211)
!245 = !DILocation(line: 51, column: 5, scope: !211)
!246 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 54, type: !18, scopeLine: 54, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !4)
!247 = !DILocation(line: 55, column: 9, scope: !246)
!248 = !DILocation(line: 55, column: 7, scope: !246)
!249 = !DILocation(line: 56, column: 9, scope: !246)
!250 = !DILocation(line: 56, column: 7, scope: !246)
!251 = !DILocation(line: 57, column: 9, scope: !246)
!252 = !DILocation(line: 57, column: 7, scope: !246)
!253 = !DILocation(line: 58, column: 5, scope: !246)
!254 = !DILocation(line: 59, column: 5, scope: !246)
!255 = !DILocation(line: 60, column: 5, scope: !246)
!256 = !DILocation(line: 61, column: 10, scope: !246)
!257 = !DILocation(line: 61, column: 5, scope: !246)
!258 = !DILocation(line: 62, column: 10, scope: !246)
!259 = !DILocation(line: 62, column: 5, scope: !246)
!260 = !DILocation(line: 63, column: 10, scope: !246)
!261 = !DILocation(line: 63, column: 5, scope: !246)
!262 = !DILocation(line: 64, column: 5, scope: !246)
